...
def eigen_train(data_tag, to_train=False, is_bin=False):
	...
	with custom_object_scope({"Projection":Projection, "EigenDist": EigenDist}):
...
if __name__ == '__main__':
	eigen_train(data_tag, to_train=False, is_bin=False)
