...
import base_real_eigen as base_model
from base_real_eigen import eigen_train
...
RealEigen.HP_ORTHONORMAL = 1
RealEigen.HP_EIGENDIST = 0.5
...
if __name__ == '__main__':
	eigen_train(data_tag, to_train=False, is_bin=True)
